...
export default function LoginWithGithub() {
  return (
    <button
      ...
      role='button'
      className='focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center justify-center w-full mt-4'
      onClick={() => {
